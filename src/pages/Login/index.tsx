            ...
            <div style={styles.Login}>
              ...
              <input
                ...
                <div style={styles.providersContainer}>
                  <button style={styles.providerButton} title="GitHub">
                  ...
                  <button style={styles.providerButton} title="Google">
                  ...
                  <button style={styles.providerButton} title="Apple">
                  ...
                  <button style={styles.providerButton} title="Microsoft">
