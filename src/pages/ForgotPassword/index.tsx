      ...
      >
        <View style={mobileStyles.spotlightWrapper} pointerEvents="none">
          <Svg height="100%" width="100%">
            <Defs>
              <RadialGradient id="forgotSpotlight" cx="50%" cy="55%" rx="55%" ry="40%" fx="50%" fy="55%" gradientUnits="userSpaceOnUse">
                <Stop offset="0" stopColor="rgba(255,255,255,0.14)" stopOpacity="1" />
                <Stop offset="1" stopColor="rgba(5,5,5,0)" stopOpacity="0" />
              </RadialGradient>
            </Defs>
            <Rect x="0" y="0" width="100%" height="100%" fill="url(#forgotSpotlight)" />
          </Svg>
        </View>
        <Navbar />
        <ScrollView
